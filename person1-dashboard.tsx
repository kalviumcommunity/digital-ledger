  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Center / Right: Search Bar with Filter */}
        <div className="flex items-center gap-4">
          <div className="relative flex items-center w-80 lg:w-96">
            ...
            <input
              ...
              className={`w-full pl-10 pr-24 py-1.5 text-sm border rounded-full focus:outline-none focus:ring-1 transition leading-normal ${
                isDarkMode
                  ? "bg-gray-800 border-gray-700 text-white placeholder-gray-400 focus:ring-white"
                  : "bg-white border-gray-400 text-black placeholder-gray-500 focus:ring-black"
              }`}
            />
            <button
              onClick={() => setHeaderFilterOpen(!headerFilterOpen)}
              className={`absolute right-1 px-3 py-1 text-xs font-semibold rounded-full border flex items-center gap-1 cursor-pointer transition ${
                isDarkMode
            ...
            {headerFilterOpen && (
              <div
                className={`absolute top-10 right-0 w-36 border rounded-xl shadow-lg py-1 z-30 text-xs font-semibold ${
                  isDarkMode
      ...
      <main className="flex-1 min-h-0 px-6 py-3.5 overflow-hidden flex flex-col">
        ...
        {/* RIGHT SIDE: TRANSACTION HISTORY (TEAMMATES WORKSPACE) */}
          ...
          >
            ...
            {/* Teammates Reserved Frame */}
            <div
              className={`flex-1 border-2 border-dashed rounded-2xl p-8 flex flex-col items-center justify-center text-center ${
                isDarkMode
            ...
            >
              <div
                className={`w-14 h-14 rounded-2xl border flex items-center justify-center mb-3 shadow-xs ${
                  isDarkMode
              ...
              <p className="text-xs text-gray-400 max-w-md leading-relaxed mb-4">
                This panel is preserved for your teammates (<strong>Person 2:</strong> Transaction CRUD &amp; Entries, and <strong>Person 3:</strong> Ledger Calculations &amp; Audit Trail).
              </p>
              {selectedCustomerId && (
                <div
                  className={`text-xs font-semibold border px-3.5 py-1.5 rounded-full shadow-xs ${
                    isDarkMode
                      ? "bg-gray-800 border-gray-700 text-gray-200"
                      : "bg-white border-gray-300 text-black"
                  }`}
                >
                  Active Customer ID Selected:{" "}
                  <span className="font-mono text-red-500">{selectedCustomerId}</span>
                </div>
              )}
            </div>
          </div>
            ...
            <form onSubmit={handleDeleteEmployee} className="space-y-4">
              ...
              >
                ...
                <div className="text-xs font-mono text-gray-400">
                  {deleteEmployeeTarget.mobile} ΓÇó {deleteEmployeeTarget.email}
                </div>
